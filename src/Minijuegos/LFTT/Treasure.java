...
public class Treasure extends JFrame implements ActionListener {
    ...
    public Treasure() {
        ...
        ImageIcon bgurl19 = new ImageIcon(getClass().getResource("/Minijuegos/LFTT/1st.png"));
        w1.setIcon(bgurl19);
        validate();
        w1.setVisible(false);
        ...
        ImageIcon bgurl20 = new ImageIcon(getClass().getResource("/Minijuegos/LFTT/2do.png"));
        w2.setIcon(bgurl20);
        validate();
        w2.setVisible(false);
        ...
        ImageIcon bgurl21 = new ImageIcon(getClass().getResource("/Minijuegos/LFTT/3ro.png"));
        w3.setIcon(bgurl21);
        validate();
        w3.setVisible(false);
        ...
        ImageIcon bgurl22 = new ImageIcon(getClass().getResource("/Minijuegos/LFTT/4to.png"));
        w4.setIcon(bgurl22);
        validate();
        w4.setVisible(false);
